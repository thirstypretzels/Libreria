...
class Comments extends Component {
    ...
    render() {
        return(
            ...
            <div class="image">
                <img src="https://www.mswordcoverpages.com/wp-content/uploads/2018/10/Book-cover-page-7-CRC.png"
                alt="bookcover"
                className="book-img"
                />
            ...
            <Form reply>
                <Form.TextArea />
                <Button content='Add Comment' labelPostion='left' icon='edit' primary/>
            </Form>
            </CommentGroup>
...
>>>>>>> 1e725c8df81da23bddc52ab06fb958454adc221c
}
